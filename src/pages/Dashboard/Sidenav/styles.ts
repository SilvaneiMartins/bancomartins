...
export const Balance = styled.div`
  ...
  button {
    ...
    background: none;
    /* color: #fff; */
    /* filter: invert(47%) sepia(17%) saturate(7494%) hue-rotate(355deg) brightness(103%) contrast(97%); */
...
export const Investment = styled.div`
  background: linear-gradient(90deg, #727376 0%, #444546 100%);
  border-radius: 4px;
  width: 216px;
  height: 32px;
  color: #fff;
